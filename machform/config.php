...
define('MF_DB_NAME', 'matthieuebase'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'matthieuebase'); //Your database username
define('MF_DB_PASSWORD', 'hiHgeE89'); //Your database users password
define('MF_DB_HOST', 'mysql51-57.perso'); //The hostname for your database
